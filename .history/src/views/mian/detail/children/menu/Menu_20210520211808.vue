            ...
            <div class="desc_main">
              ...
              <div class="main_btn flex">
                <div class="btn_price">
                  ...
                  <span class="originPrice" v-if="food.specfoods[0].original_price">{{food.specfood[0].original_price}}</span>
                </div>
...
<script>
  ...
  export default {
    ...
    setup(props, ctx) {
      const {menu, recommend, menuSelect, menu_index, con_height} = menuModel()
      console.log(menu)
      return {
        menu,
        recommend,
