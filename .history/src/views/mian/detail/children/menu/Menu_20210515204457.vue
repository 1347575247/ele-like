      ...
      <div class="recommend_view">
        <ul class="view_slide flex">
          <li class="slide_item">
            ...
            <p class="item_name t_ellipsis">虾仁玉米粥</p>
            <p class="item_rating">
              <span>月售4份</span>- <span>好评100%</span>
            </p>
            <div class="item_count flex">
              <span class="count_price">68</span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="main_con grow_shrink">
        <div class="slideWrap">
          <dl class="con_item">
            <!-- 分类标题 -->
            <dt class="item_title">
              <span class="title_main">热销</span>
              <span class="title_desc">大家喜欢吃，才叫真的好吃</span>
            </dt>
            <!-- 主体内容 -->
            <dd class="item_desc flex">
              <img class="desc_img" src="" alt="" />
              <div class="desc_main">
                <h3 class="main_name t_ellipsis">香芋地瓜丸</h3>
                <p class="main_rating t_ellipsis">
                  <span>月售261份</span> <span>好评率10%</span>
                </p>
...
<style lang="scss">
.menu {
   .menu_recommend { margin-top: 0.533333rem;//20
   .recommend_title { margin-left: 0.4rem;//15
              ...
              .main_class {
                ...
                .class_item {
                  ...
                  .item_title {
                    ...
                    .title_desc { color: #999; } }
                    // 商品主要描述
                    .item_desc { margin-top: 0.533333rem;//20
                    .desc_img { width: 2.533333rem;//95
                    height: 2.533333rem;
                    ...
                    .desc_main {
                      ...
                      .main_btn {
                        ...
                        .btn_price {
                          color: #F07373;
                          span {}
                          .price { font-size: 0.426666rem;//16 //
                          line-height:26px;
                          &::before { content: '￥'; }
                          } .originPrice { &::before { content: '￥'; } text-decoration:line-through; color:#ccc; } } } } } } } } }
</style>
