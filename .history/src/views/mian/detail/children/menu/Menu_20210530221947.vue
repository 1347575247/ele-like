        ...
        <ul class="view_slide flex">
          <li class="slide_item" v-for="(item, i) in recommend[0].items" :key="i" >
            ...
            <div class="item_count flex">
              ...
              <BaseButton :count="count(item)" @changeNum="changeNum(item, $event)"/>
            </div>
          ...
          <dd class="item_desc flex" v-for="(food,j) in item.foods" :key="j">
            ...
            <div class="desc_main">
              ...
              <div class="main_btn flex">
                ...
                <BaseButton :count="count(food)" @changeNum="changeNum(food, $event)"/>
              </div>
...
<script>
  ...
  export default {
    ...
    setup(props, ctx) {
      const {menu, recommend, count, changeNum} = menuModel()
