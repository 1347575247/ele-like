<template>
  <div class="b-background">
    <vHead title="添加地址" @back="back"></vHead>
...
import { Form, Field, Cell, Button, RadioGroup, Radio, Area, Popup, Overlay, Picker, Toast } from 'vant'
...
export default {
  ...
  setup(props, context) {
    const { back, state, onSubmit, onConfirm, areaList } = addModel()
