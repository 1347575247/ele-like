<template>
    ...
    <ul class="order-list">
      <router-link :to="{path: '/order/order-detail'}">
        <li class="item">
          <div class="shop flex">
          ...
          <div class="operator">
            <van-button plain type="danger" size="small" @click.stop="$router.push('/order/rate')">评价得金币</van-button>
      ...
      <router-link :to="{path: '/order/order-detail'}">
        <li class="item">
          ...
          <div class="operator">
            <van-button plain type="danger" size="small">评价得金币</van-button>
            <van-button plain type="primary" size="small">再来一单</van-button>
          </div>
        </li>
      </router-link>
