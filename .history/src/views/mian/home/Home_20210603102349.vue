<template>
    ...
    <!-- 首页列表 -->
    <Elist class="p-spacing" v-if="hasLogin"></Elist>
		
    <!-- 去登录 -->
    <ToLogin v-if="!hasLogin"></ToLogin>
...
<script>
  ...
  import ToLogin from '@comps/login/ToLogin.vue'
  
	import { Swipe, SwipeItem } from 'vant';
  import homeModel from './js/homeModel.js'
  import hasLogin from '@/utils/loginState.js'
	export default{
		components:{
			vHead,
			Side,
