      ...
      <div class="rate-delivery">
        ...
        <div class="rate-1">
          ...
          <ul class="rate-btns">
            ...
            <li @click="deliverRate(1)" :style="rate.delivery.activeIndex === 0 ? { color : 'rgb(137, 159, 188)', background: '#fff2ea'}: ''">
              <span :class="'iconfont icon-smile '+ rate.delivery.activeIndex === 1 ?'active':''"></span>
              <span>一般</span>
            </li>
