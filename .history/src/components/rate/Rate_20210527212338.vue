    ...
    <div class="rate p-spacing">
      ...
      <div class="rate-delivery">
        ...
        <div class="rate-1">
          ...
          <ul class="rate-btns">
            <li @click="deliverRate(0)">
              <span class="iconfont icon-chaping" :style="rate.delivery.activeIndex === 0 ? { color: '#95a5c3', borderColor: '#9aadc5',backgroundColor: '#e7ecf2'}: ''"></span>
              <span>非常差</span>
            </li>
            <li @click="deliverRate(1)">
              <span class='iconfont icon-smile' :style="rate.delivery.activeIndex === 1 ? { color: 'rgb(255, 115, 28)', borderColor: 'rgb(255, 115, 28)',backgroundColor: 'rgb(255, 242, 234)'}: ''"></span>
              <span :style="rate.delivery.activeIndex === 1 ? { color: 'rgb(255, 115, 28)'}: ''">一般</span>
            </li>
            <li @click="deliverRate(2)">
              <span class="iconfont icon-haoping" :style="rate.delivery.activeIndex === 2 ? { color: '#ff731c', backgroundColor: '#fff2ea'}: ''"></span>
              <span :style="rate.delivery.activeIndex === 2 ? { color: '#ff731c'}: ''">超赞</span>
            </li>
          </ul>
          <ul class="rate-tags" v-if="0">
            <li class="active">送餐快</li>
            <li>餐品完好</li>
            <li>服务态度好</li>
            <li>准时到达</li>
            <li>穿着专业</li>
      ...
      <!-- 底部按钮 -->
      <div class="bottom-btn">请对骑士服务作出评价</div>
    </div>
  </div>
...
<script>
  import {Progress, Rate, Icon} from 'vant'
  import rateModel from './js/rateModel'
    ...
    setup(props, ctx) {
      const {rate, rateObj, overallChange, packageChange, qualityChange, deliverRate} = rateModel()
      return {
        rate,
        rateObj,
        overallChange,
