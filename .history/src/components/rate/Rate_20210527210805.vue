        ...
        <div class="rate-1">
          ...
          <ul class="rate-btns">
            <li @click="deliverRate(0)">
              <span class="iconfont icon-chaping" :style="rate.delivery.activeIndex === 0 ? { background : 'rgb(137, 159, 188)' }: ''"></span>
              <span :style="rate.delivery.activeIndex === 0 ? { color : 'rgb(137, 159, 188)' }: ''">非常差</span>
            </li>
            <li @click="deliverRate(1)">
              <span class="iconfont icon-smile active"></span>
              <span>一般</span>
            </li>
