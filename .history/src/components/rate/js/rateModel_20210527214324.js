...
export default function rateModel() {
  ...
  function addComment(e) {
    ...
    if(data.rate.delivery.activeIndex != 1) {
      e.target.style.cssText = `background-color: '#fff2ea'; border-color: '#ff731c'; color: '#ff731c'`
    }else {
      e.target.style.cssText = `background-color: '#e7ecf2'; border-color: '#9aadc5'; color: '#95a5c3'`
    }
  }
