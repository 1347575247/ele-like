<template>
    ...
    <div class="main">
      ...
      <div class="detail br-radius p-spacing">
        ...
        <ul class="food-list" v-if="foodState" :style="{maxHeight: show.isUnfolded ? '9.2rem' : nowListHeight(foodLength)}">
...
<script>
  ...
  import { Popup, Overlay, Step, Steps, NoticeBar, Icon, TreeSelect, Sidebar,SidebarItem   } from 'vant';
    ...
    setup(props, ctx) {
      const {show, back, activeId, activeIndex, timeSelectItems, timeChosen, deliver, foodState, firstItem, feeFormat, foodLength, nowListHeight} = checkModel()
