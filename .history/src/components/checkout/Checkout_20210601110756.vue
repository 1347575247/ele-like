...
<script>
  ...
  import { Popup, Overlay, Step, Steps, NoticeBar, Icon, TreeSelect, Sidebar,SidebarItem   } from 'vant';
    ...
    setup(props, ctx) {
      const {show, back, activeId, activeIndex, timeSelectItems, timeChosen, deliver, foodState, firstItem} = checkModel()
