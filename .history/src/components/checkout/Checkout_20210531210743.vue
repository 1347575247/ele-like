<template>
    ...
    <div class="main">
      ...
      <div class="aftet-sell">
        ...
        <div class="deliver-time p-spacing">
          <span class="text">立即送出</span>
          <span class="time">明日（周二）09:30送达</span>
        </div>
...
<script>
  ...
  import { Popup, Overlay, Step, Steps, NoticeBar, Icon } from 'vant';
