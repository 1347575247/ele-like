<template>
    ...
    <div class="main">
      ...
      <ConfirmBar :price="priceTotal" :discount="discountTotal"></ConfirmBar>
    </div>
...
<script>
  ...
  import ConfirmBar from './children/ConfirmBar.vue'
    ...
    setup(props, ctx) {
      const {show, back, activeId, activeIndex, timeSelectItems, timeChosen, deliver, foodState, firstItem, feeFormat, foodLength, nowListHeight, dicountTotal, priceTotal} = checkModel()
