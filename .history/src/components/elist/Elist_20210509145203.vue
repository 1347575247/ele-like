    ...
    <div class="good-item" v-for="(item, i) in elistData" :key="i">
      ...
      <div class="desc">
        ...
        <div class="insurrance-box">
          <div class="insure-item" v-for="(i, o) in item.restaurant.supports" :key="o">
            <span class="icon">{{i.id==7?'保':i.id==4?'票':''}}</span>
            <span class="sm-font t_ellipsis">{{i.description}}</span>
