<template>
  <div class="good-list">
    <div class="good-item" v-for="(item, i) in 20" :key="i">
      <div class="img-box">
        <img
          src="https://cube.elemecdn.com/d/d1/e777be0b578fabb2e2a50234697fcjpeg.jpeg?x-oss-process=image/format,webp/resize,w_130,h_130,m_fixed"
          alt=""
        />
      </div>
      <div class="desc">
        ...
        <div class="cate sm-font">名酒坊</div>
