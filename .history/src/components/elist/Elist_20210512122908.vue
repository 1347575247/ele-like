<template>
  <div class="good-list" v-if="itemData">
    <div class="good-item" v-for="(item, i) in itemData.data" :key="i" :style="showActive(ac)">
      <div class="img-box">
        <img
      ...
      <div class="desc">
        ...
        <div class="insurrance-box">
          <div class="insure-item" v-for="(acItem, ac) in item.restaurant.activities" :key="ac">
            ...
            <div class="activity-num" v-if="ac === 0" @click="showActivityFn(ac)">
...
export default {
  ...
  setup(props, context) {
    const {getNewElistData, itemData, calDistance, showActivityFn, showActive} = elistModel()
    return {
      calDistance,
      itemData,
      showActive,
