<template>
  <div class="insurrance-box" v-if="data.restaurant.activities">
    <div
      class="insure-item"
      v-for="(acItem, ac) in data.restaurant.activities"
      :key="ac"
    >
      <span
        class="icon"
      ...
      <div class="activity-num" v-if="ac === 0" @click.stop="showActivityFn(i)">
