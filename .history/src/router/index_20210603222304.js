...
const Redpacks = () => import('@comps/benefit/children/Redpacks.vue')
const MerchantsRedpacks = () => import('@comps/benefit/children/Merchants.vue')
const OffsetRedpacks = () => import('@comps/benefit/children/Offsets.vue')
...
const routes =[
  ...
  { /* 我的优惠 */
    ...
    children: [
      ...
      { /* 店铺红包 */
        path: 'merchants',
        component: MerchantsRedpacks
      },
      { /* 抵用卷 */
        path: 'offsets',
        component: OffsetRedpacks
      }
    ]
  },
  { /* 404 */
